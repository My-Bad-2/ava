...
inline FILE stdio_dummy_file(char* buffer, size_t buffer_size)
{
	size_t usable_buffer_size =
		(buffer_size > STDIO_MAX_BUFFER_SIZE) ? STDIO_MAX_BUFFER_SIZE : (size_t)buffer_size;
